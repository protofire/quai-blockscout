defmodule BlockScoutWeb.API.V2.BlockView do
  ...
  def prepare_block(block, _conn, single_block? \\ false) do
    ...
    %{
      ...
      "parent_uncled_delta_entropy" => block.parent_uncled_delta_entropy,
      ...
      "prime_terminus_hash" => block.prime_terminus_hash,
      "interlink_root_hash" => block.interlink_root_hash,
      "uncled_entropy" => block.uncled_entropy,
      # "uncles" => block.uncles,
